...
<head>
  ...
  <title>Estações de Combustível</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
       ...
       <li class="nav-item">
            <a href="estacao.php" class="nav-link active">
              <i class="nav-icon "></i>
              <p>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-6">
				<h4 class="mt-2 text-primary"> Estações de Combustível</h4>
			</div>
			<div class="col-lg-6">
				<button type="button" class="btn btn-primary m-1 float-right" data-toggle="modal" data-target="#addModal"><i class="fas fa-user-plus fa-log"></i>&nbsp;&nbsp; Adecionar Nova Estações de Combustível</button>
