  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
       ...
       <li class="nav-item">
            <a href="motorista.php" class="nav-link active">
              <i class="nav-icon "></i>
              <p>
                Motorista
              </p>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-6">
				<h4 class="mt-2 text-primary">Motorista</h4>
			</div>
			<div class="col-lg-6">
				<button type="button" class="btn btn-primary m-1 float-right" data-toggle="modal" data-target="#addModal"><i class="fas fa-id-card"></i>&nbsp;&nbsp;Add New User</button>
	    ...
	    <div class="modal-dialog modal-dialog-centered">
	      <div class="modal-content">
	        ...
	        <div class="modal-header">
	          <h4 class="modal-title">Adcionar dados de motorista</h4>
	        ...
	        <div class="modal-body px-4">
	          <form action="" method="POST" id="form-data">
                  ...
                  <div class="form-group">
	          		<input type="text" name="veiculo" class="form-control" placeholder="Veiculo" required>
	          	</div>
                  <div class="form-group">
	          		<input type="text" name="carta" class="form-control" placeholder="Carta" required>
	          	</div>
                  <div class="form-group">
	          	...
	          	<div class="form-group">
	          		<input type="submit" name="insert" id="insert" value="Adcionar" class="btn btn-danger btn-block">
	          	</div>
	          </form>
	        </div>
	      </div>
